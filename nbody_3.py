"""
    ...
    This program runtime: 107.72342138
    Relative Speedup: 1.0119691484032216
    Rank:
"""
import timeit
...
def advance(dt):
    ...
    seenit = []
    for body1 in bodies_local.keys():
        for body2 in bodies_local.keys():
...
if __name__ == '__main__':
    ...
    print(timeit.timeit("nbody(100, 'sun', 20000)", setup=setup, number=1))
